...
namespace TheAionProject
{
    ...
    public class ConsoleView
    {
        ...
        public void DisplayLocationsVisited()
        {
            ...
            foreach (int spaceTimeLocation in _gameTraveler.SpaceTimeLocationsVisited)
            {
                visitedSpaceTimeLocations.Add(_gameUniverse.GetSpaceTimeLocationById(spaceTimeLocation));
            }

            DisplayGamePlayScreen("Space-Time Locations Visited", Text.VisitedLocations
                (visitedSpaceTimeLocations), ActionMenu.MainMenu, "");
        }
        ...
        public void DisplayListOfListOfSpaceTimeLocations()
        {
