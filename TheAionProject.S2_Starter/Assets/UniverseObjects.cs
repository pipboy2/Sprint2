    ...
    public static class UniverseObjects
    {
        public static List<SpaceTimeLocation> SpaceTimeLocations = new List<SpaceTimeLocation>()
        {
            ...
            new SpaceTimeLocation
            {
                ...
                UniversalDate = 386759,
                UniversalLocation = "P-5, SS-564, G-2964, LS-3254",
                Description = "BettelJuice is located on the far reaches of the Universe. " +
                    "It is said that there was once a great man from this planet that carried a book " +
                    "and towel wherever he went.\n",
                GeneralContents = "The planet is very much like earth in its " +
                    "atmosphere. But everytime you try to get close to it two warning " +
                    "missles get shot at you. Its ok, tis' a silly place. \n",
                Accessable = true,
                ExperiencePoints = 10
            }
        };
